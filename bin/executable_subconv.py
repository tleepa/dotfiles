...
def usage():
 ...
 Usage: subconv [-i fmt|-o fmt|-a sec|-s sec|-S h:m:s[,h:m:s,...]] input [output1, output2, ...]
     ...
     -i fmt        input format (one of: txt, srt, tmp, mdvd, sub2, mpl2, auto; auto by default)
...
def read_mdvd(list, fps):
    """
    Read micro-dvd subtitles, e.g. :
    #	Format klatkowy
    #	{258}{293} Przykladowy tekst.
    input: contents of a file as list
...
def read_mpl2(list):
    """
    Read mpl2 subtitles, e.g. :
    #	Format czasowy z dokladnoscia do 0,1s.
    #	[35812][35827]To kim ty jestes?
    input: contents of a file as list
...
def read_tmp(list):
    """
    Reads tmplayer (tmp) subtitles, e.g. :
    #	Format czasowy
    #	00:59:41:To kim ty jestes?
    input: contents of a file as list
    returns: list of subtitles in form: [[time_dep, time_end, line1, ...],[time_dep, time_end, line1, ...],....]
    """
